...
<table style="width:1000px;height:30px;border:0px;">
    ...
    <tr>    
        <td align="center" valign="middle" style="width:200px;height:30px;background-color:#CCCCCC;">포인트</td>
        <td align="left" valign="middle" style="width:800px;height:30px;"><input type="text" name="m_point" style="width:780px;" value="<?=$data[m_point]?>"></td>
    </tr>
